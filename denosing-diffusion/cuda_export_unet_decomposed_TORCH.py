...
class SinusoidalPosEmb(Module):
    ...
    def forward(self, x):
        ...
        my_arrange = torch.tensor([i for i in range(half_dim)], dtype=torch.float32, device=device)
...
class ResnetBlock(Module):
    ...
    def forward(self, x, time_emb = None):
        ...
        if exists(self.mlp) and exists(time_emb):
            ...
            print("scale_shift has shape", scale_shift[1].shape)
            print("scale_shift has shape", scale_shift[2].shape)
